...
for i, row in tqdm(verbnoun_df.iterrows()):
    ...
    for line in ger_verb_lines:
        ger_verb_past_form = line.split("\t")[1]
        ger_verb_prat_forms.append(ger_verb_past_form)
    if len(ger_verb_lines) == 1:
        ger_verb_prat_form_col.append(ger_verb_prat_forms[0])
        # ger_checked_verbs[row[1].verb_ger] = ger_verb_perf_forms[0]
        print(ger_verb_prat_forms[0])
    else:
        ger_verb_prat_form_col.append(ger_verb_prat_forms)
        # ger_checked_verbs[row[1].verb_ger] = ger_verb_perf_forms
        print(ger_verb_prat_forms)
...
verbnoun_df["impf_3"] = ger_verb_prat_form_col
